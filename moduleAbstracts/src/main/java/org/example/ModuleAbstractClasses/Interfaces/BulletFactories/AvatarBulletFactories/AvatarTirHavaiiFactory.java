...
public interface AvatarTirHavaiiFactory extends BulletFactory {
    @Override
    ...
    default MoveFuncs getBulletMoveFunction() {
        return MoveFuncs.AVATAR_TIR_HAVAII;
    }

    @Override
    default List<ImagePattern> getBulletAnimationImagePatterns() {
        return new ArrayList<>(List.of(new ImagePattern(ImageHandler.imageFactory("cuphead_frames/frames/images/bullet.png")  )));
    }
