...
public class PoultryBulletStageTest extends Application implements BulletTransitionFactory {
    ...
    private void initializeStageComponents() {
        ...
        createPoultryTransitionAndPlayIt();
    }
    ...
    private void createPoultryTransitionAndPlayIt() {
        PoultryBulletFactoryCreator poultryBulletFactory = new PoultryBulletFactoryCreator();
        createBulletTransition(poultryBulletFactory.getNewBossBirdBulletFactory(1),new Location(Constants.BOSS_BIRD_POULTRY_X ,SetConstants.BOSS_BIRD_POULTRY_Y)).play();
    }
