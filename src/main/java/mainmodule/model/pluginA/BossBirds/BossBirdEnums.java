...
import mainmodule.model.pluginA.BulletFactories.BedBossBirdBulletFactories.BedBossBirdBulletFactoryType3;
...
import java.util.Map;
    ...
    public enum BossBirdEnums {
        ...
        }})),new ArrayList<>(List.of(new BedBossBirdBulletFactoryType1(){}, new BedBossBirdBulletFactoryType2(){}, new BedBossBirdBulletFactoryType3(){}, new BedBossBirdBulletFactoryType4(){})), Constants.X_DISTANCE_3,Constants.Y_DISTANCE_3),Constants.BOSS_BIRD3_HEALTH);
