...
public enum Bullets {
    ...
    }}, 1, Constants.MINI_BOSS_BULLET_DURATION),
    ...
    AVATAR_BULLET(Constants.AVATAR_BULLET_HEIGHT,Constants.AVATAR_BULLET_WIDTH,Constants.AVATAR_BULLET_SPEED, SetConstants.AVATAR_BULLET_DAMAGE_RATIO,MoveFuncs.AVATAR_BULLET, new ArrayList<>(List.of(new ImagePattern(new Image(Main.class.getResource("cuphead_frames/frames/images/bullet.png").toExternalForm())))), 1,Constants.AVATAR_BULLET_DURATION),
    ...
    }}, 1,Constants.BED_BOSS_BULLET_DURATION),
    ...
    }}, 1,Constants.BED_BOSS_BIRD_BULLET_DURATION),
    ...
    }}, 1,Constants.DOCTOR_BIRD_BULLET_DURATION),
    ...
    }}, 1,Constants.BOSS_BIRD_POULTRY_DURATION),
    ...
    Bullets(int height, int width, int speed, int damageRatio, MoveFuncs moveFuncs, ArrayList<ImagePattern> imagePattern, int cycleCount, int cycleDuration) {
        this.height = height;
        this.width = width;
        this.speed = speed;
